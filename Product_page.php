...
<body>
    ...
    <header id="main-header">
        ...
        <nav class=" navbar navbar-expand-lg bg-light ">
            <div class="container">
                ...
                <div id="top-option"><ion-icon style="z-index: -1;position: relative;" id="main-cart" name="bag-handle-outline"></ion-icon>
                </div>
            </div>
            </div>
            </div>
    ...
    <div class="footer">
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-4 col-lg-3 ">
                    <div class="footer-section-first p-3">
                ...
                <div class="col-12 col-md-4 col-lg-3 ">
                    <div class="footer-section-second p-3">

                        <h4><strong>Customer Services</strong></h4>
                        <a href="#" class="footer-link m-1 text-decoration-none text-dark">My Wishlist</a>
                        <br>
                        <a href="#" class="footer-link m-1 text-decoration-none text-dark">Track your Order</a>
                        <br>
                        <a href="#" class="footer-link m-1 text-decoration-none text-dark">Paymlient Options</a>
                        <br>
                        <a href="#" class="footer-link m-1 text-decoration-none text-dark">FAQ</a>


                    </div>
                </div>
                <div class="col-12 col-md-4 col-lg-3 justify-content-center">
                    <div class="footer-section-third p-3">
                        <h4><strong>Contact Us </strong></h4>

                        <strong>Help line</strong>
                        <br>
                        <strong>000-00000-000</strong>
                        <br>
                        <strong>mrbadshahbusiness@gmail.com </strong>
                    </div>
                </div>


                <div class="col-12 col-md-4 col-lg-3">
                    <div class="footer-section-four p-3">
                        <h4><strong>Location: </strong></h4>
                        <b>Maps</b>
                        <a href="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d28948.35690566914!2d67.04332799965606!3d24.913510400160355!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3eb33f3fd0ceabfd%3A0x9d6aa5a7311118c9!2sAR%20Games%20%26%20Tech%20store!5e0!3m2!1sen!2s!4v1700612137239!5m2!1sen!2s" class=" text-dark">Gooogle Location</a>
                        <br>
                        <div class="p-1 ">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d28948.35690566914!2d67.04332799965606!3d24.913510400160355!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3eb33f3fd0ceabfd%3A0x9d6aa5a7311118c9!2sAR%20Games%20%26%20Tech%20store!5e0!3m2!1sen!2s!4v1700612137239!5m2!1sen!2s" width="275" height="300" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-6">
                        <form action="">
                            ...
                            <div class="form-floating mb-3 ">
                                <input name="Repeatpassword" type="email" id="email-for-footer-Subscribe" class="form-control" placeholder="Email">
                                <label for="floatingPassword">Email</label>
                                <ion-icon class="arrow-for-Subscribe" name="arrow-forward-outline"></ion-icon>
                            </div>
                        </form>
                    </div>
                    <div class="col-12 col-md-6 col-lg-6">
        ...
        <hr>
        <footer class="p-1">&copy;Digilog.pk_2023</footer>
        <div class="rating">Rating<ion-icon name="star-outline"></ion-icon><ion-icon name="star-outline"></ion-icon><ion-icon name="star-outline"></ion-icon><ion-icon name="star-outline"></ion-icon><ion-icon name="star-outline"></ion-icon></div>
    </div>
